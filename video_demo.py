...
weights_path = "model/weights.0100.h5"  # orginal weights converted from caffe
...
vidcap = cv2.VideoCapture('/home/richard/Videos/How_People_Walk.mp4')
...
while success:
    if count % 10:
        ...
        cv2.imshow('video_output', canvas)
    success, test_image = vidcap.read()
    count += 1
